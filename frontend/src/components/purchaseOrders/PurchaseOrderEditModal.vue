  ...
  <Dialog :open="open" @update:open="(val) => emit('update:open', val)">
    <DialogContent class="w-full max-w-[98vw] sm:max-w-5xl max-h-[95vh] overflow-y-auto px-6 py-4">
      ...
      <div class="grid gap-4 py-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="grid grid-cols-4 items-center gap-4">
            <label for="documentDate" class="text-right">Document Date</label>
            <Input id="documentDate" v-model="form.documentDate" type="date" class="col-span-3" />
          </div>

          <div class="grid grid-cols-4 items-center gap-4">
            <label for="invoiceReceivedDate" class="text-right">Invoice Received</label>
            <Input
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="grid grid-cols-4 items-center gap-4">
            <label for="postingDate" class="text-right">Posting Date</label>
            <Input id="postingDate" v-model="form.postingDate" type="date" class="col-span-3" />
          </div>

          <div class="grid grid-cols-4 items-center gap-4">
            <label for="vatReportingDate" class="text-right">VAT Reporting Date</label>
            <Input
              id="vatReportingDate"
              v-model="form.vatReportingDate"
              type="date"
              class="col-span-3"
            />
          </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="grid grid-cols-4 items-center gap-4">
            <label for="buyFromAddress2" class="text-right">Address 2</label>
            <Input id="buyFromAddress2" v-model="form.buyFromAddress2" class="col-span-3" />
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="grid grid-cols-4 items-center gap-4">
            <label for="buyFromPostCode" class="text-right">Post Code</label>
            <Input id="buyFromPostCode" v-model="form.buyFromPostCode" class="col-span-3" />
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="grid grid-cols-4 items-center gap-4">
            <label for="buyFromContactMobilePhoneNo" class="text-right">Mobile Phone</label>
            <Input
              id="buyFromContactMobilePhoneNo"
              v-model="form.buyFromContactMobilePhoneNo"
              class="col-span-3"
            />
          </div>

          <div class="grid grid-cols-4 items-center gap-4">
            <label for="buyFromContactNo" class="text-right">Contact No</label>
            <Input id="buyFromContactNo" v-model="form.buyFromContactNo" class="col-span-3" />
          </div>
        </div>
