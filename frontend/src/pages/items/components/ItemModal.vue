    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
      <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="space-y-4">
            <div>
              <h3 class="font-medium text-gray-700">Item Number</h3>
              <p class="mt-1">{{ item?.item_no }}</p>
            </div>
            <div>
              <h3 class="font-medium text-gray-700">Type</h3>
              <p class="mt-1">{{ item?.item_type }}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p class="mt-1">{{ item?.item_category_code }}</p>
            </div>
          </div>
          ...
          <div class="space-y-4">
            ...
            <div>
              <h3 class="font-medium text-gray-700">Unit Cost</h3>
              <p class="mt-1">${{ item?.unit_cost }}</p>
            </div>
            <div>
